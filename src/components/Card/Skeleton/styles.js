...
export const ScSmallRoot = styled.div`
    position: relative;
    fontfamily: oxanium;
    width: 280px;
    margin-right: 60px;
...
export const ScSmallCardBorder = styled.div`
    width: 280px;
    clip-path: polygon(10% 0, 100% 0, 100% 90%, 90% 100%, 0 100%, 0 10%);
    height: 380px;
    background-color: #a8a8a8;
...
export const ScSmallCard = styled.div`
    width: 278px;
    height: 378px;
    overflow: hidden;
    color: black;
...
export const ScSmallCardImage = styled.div`
    height: 280px;
    width: 100%;
    background: linear-gradient(to right, #fcfcfc, #e9e9e9, #dedede, #e9e9e9, #fcfcfc);
    background-size: 300% 100%;
...
export const ScSmallCardDetailContainer = styled.div`
    height: 150px;
    padding: 20px;
    display: flex;
    justify-content: space-between;
...
export const ScSmallCardBrand = styled.div`
    height: 11px;
    width: 150px;
    background: linear-gradient(to right, #fcfcfc, #e9e9e9, #dedede, #e9e9e9, #fcfcfc);
    background-size: 300% 100%;
...
export const ScSmallCardName = styled.div`
    height: 17px;
    width: 100%;
    background: linear-gradient(to right, #fcfcfc, #e9e9e9, #dedede, #e9e9e9, #fcfcfc);
    background-size: 300% 100%;
...
export const ScSmallCardPromotionPrice = styled.div`
    font-size: 19px;
    line-height: 19px;
    font-weight: 800;
`;

export const ScSmallCardPriceBeforePromotion = styled.div`
    font-size: 14px;
    line-height: 14px;
    color: red;
`;

export const ScSmallCardShadow = styled.div`
    clip-path: polygon(10% 0, 100% 0, 100% 90%, 90% 100%, 0 100%, 0 10%);
    height: 380px;
    width: 280px;
    background-color: black;
